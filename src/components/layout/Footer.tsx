...
const footerLinks = [
  {
    ...
    links: [
      ...
      { href: "/create-campaign", label: "Kampanya Oluştur" },
      { href: "/general-vault", label: "Genel Kasa" },
      { href: "/transparency", label: "Şeffaflık" },
    ],
  },
  {
    title: "Kaynaklar",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-muted-foreground max-w-sm mb-6">
              ...
              şeffaf ve güvenli hale getiren platform.
            </p>
